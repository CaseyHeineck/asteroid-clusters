...
class Game:
    ...
    def _apply_banish_ability(self, platform_class):
        ...
        _variant_attr = {
            ...
            "kill_drain":            "kill_drain_rate",
            "kill_momentum":         "kill_momentum",
            "mark_amplification":    "mark_amplification",
            "mark_duration":         "mark_duration",
            "mine_radius":           "explosion_radius",
            "overkill_intensity":    "overkill_amp",
            "pellet_count":          "pellet_count",
            "pierce_count":          "pierce_count",
            "projectile_speed":      "projectile_speed",
            "range_multiplier":      "max_multiplier",
            "rapid_retarget":        "rapid_retarget",
            "resonance_buildup":     "max_tier",
            "resonance_cap":         "tier_multiplier",
